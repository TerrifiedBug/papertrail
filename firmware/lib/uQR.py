# uQR - pure-Python QR Code generator for MicroPython.
# Vendored verbatim from JASchilz/uQR (https://github.com/JASchilz/uQR),
# a MicroPython port of lincolnloop/python-qrcode.
# License: BSD-2-Clause, Copyright (c) 2018 Joseph Schilz (see LICENSE in that repo).
# Local change: ONLY the first import line is wrapped for CPython host-testability
#   (MicroPython ships "ure"; CPython ships "re"). Algorithm is untouched.
#
# Referenced by the papertrail contract as firmware/lib/uQR.py.
try:
    import ure as re   # MicroPython
except ImportError:
    import re          # CPython (host tests)
